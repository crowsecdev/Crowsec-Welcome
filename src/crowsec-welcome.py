...
class Ui_WelcomeScreen(object):
    ...
    def forumButtonAction(self):
        webbrowser.get('google-chrome-stable %s').open_new_tab('http://www.google.com')
    ...
    def startCheckAction(self):
        if self.launchAtStartCheck.isChecked():
            ...
            autostartfile = os.path.join(homedir, ".config/autostart/crowsec-welcome.desktop")
            subprocess.Popen(["cp", "/usr/share/applications/crowsec-welcome.desktop", autostartfile])
        else:
            homedir = os.path.expanduser('~')
            autostartfile = os.path.join(homedir, ".config/autostart/crowsec-welcome.desktop")
    ...
    def setupUi(self, WelcomeScreen):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/crowsec-welcome.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/wiki.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Logo.setText("")
        self.Logo.setPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/logo.png"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/donate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/chat.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/install.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/forums.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/helpus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("/usr/share/crowsec-welcome/img/news.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, WelcomeScreen):
        ...
        self.welcomeLabel.setText(_translate("WelcomeScreen", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600;\">Welcome to CrowsecOS Beta 1  GNU/Linux !</span></p></body></html>"))
        ...
        self.languageSelector.setItemText(27, _translate("WelcomeScreen", "Norwegian Bokmal"))
        ...
        self.infoLabel.setText(_translate("WelcomeScreen", "<html><head/><body><p align=\"center\">Welcome to CrowsecOS Beta 1  GNU/Linux. The links below will help you get started with CrowsecOS Beta 1 . So enjoy the experience, and don\'t hesitate to send us your feedback.</p></body></html>"))
